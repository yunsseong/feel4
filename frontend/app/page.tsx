...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 sm:p-24 relative overflow-hidden">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm flex absolute top-8 left-0 right-0 px-8">
        <div className="font-bold text-2xl tracking-tighter">Bibliy</div>
        <Link
